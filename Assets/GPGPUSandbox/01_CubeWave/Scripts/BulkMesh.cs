...
namespace UnityGpuSandbox.CubeWave
{
    partial class CubeWave
    {
        ...
        class BulkMesh
        {
            ...
            // Copy count.
            int copyCount;
            public int CopyCount { get { return copyCount; } }
            ...
            public BulkMesh(Mesh[] shapes, int maxCopyCount)
            {
                this.maxCopyCount = Mathf.Min(maxCopyCount, 4096);
            ...
            void CombineMeshes(Mesh[] shapes)
            {
                ...
                var vc = 0;
                var ic = 0;
                for (copyCount = 0; copyCount < maxCopyCount; copyCount++)
                {
                    var s = cache[copyCount % cache.Length];
